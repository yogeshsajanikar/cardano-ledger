...
/* package cardano-ledger-conway-test-1.1.0.0 */
#ifndef VERSION_cardano_ledger_conway_test
#define VERSION_cardano_ledger_conway_test "1.1.0.0"
#endif /* VERSION_cardano_ledger_conway_test */
#ifndef MIN_VERSION_cardano_ledger_conway_test
#define MIN_VERSION_cardano_ledger_conway_test(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cardano_ledger_conway_test */
...
#define CURRENT_PACKAGE_KEY "cardano-ledger-conway-test-1.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "cardano-ledger-conway-test-1.1.0.0-inplace"
