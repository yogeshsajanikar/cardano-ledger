...
/* package genvalidity-scientific-1.0.0.0 */
#ifndef VERSION_genvalidity_scientific
#define VERSION_genvalidity_scientific "1.0.0.0"
#endif /* VERSION_genvalidity_scientific */
#ifndef MIN_VERSION_genvalidity_scientific
#define MIN_VERSION_genvalidity_scientific(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_genvalidity_scientific */
...
#define CURRENT_COMPONENT_ID "cardano-ledger-core-1.2.0.0-inplace-tests"
