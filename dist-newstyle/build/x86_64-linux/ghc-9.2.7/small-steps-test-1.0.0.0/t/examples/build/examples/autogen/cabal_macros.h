...
/* package tasty-expected-failure-0.12.3 */
#ifndef VERSION_tasty_expected_failure
#define VERSION_tasty_expected_failure "0.12.3"
...
#define CURRENT_COMPONENT_ID "small-steps-test-1.0.0.0-inplace-examples"
